...
import { func_fetch_data, get_stateLoading } from "../src/asset/constant/f";
...
function Component_Fetch_Data_From_API_With_Fetch() {
  ...
  return (
    <div>
      <h3>Fetch Data from API with Fetch</h3>
      ...
      <p> {stateData ? stateData : "empty text"}</p>
    </div>
  );
}
...
function AppTwo(props) {
  return (
    <div className="AppTwo">
      ...
      <Component_Fetch_Data_From_API_With_Fetch />
      <FooterComponent />
      <Component_Form_1 />
