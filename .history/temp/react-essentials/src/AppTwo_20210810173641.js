...
function Component_Form_1() {
  ...
  return (
    <div>
      ...
      <p>The input_text_firstName = {input_firstName === "(no value)" ? "" : input_firstName} </p>
      <p>The select_car_option = {input_select === "" ? "(no value)" : input_select}</p>
      <p>The input_checkbox = {input_checkbox}</p>
    </div>
  );
}
