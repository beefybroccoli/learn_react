...
function Component_Form_2() {
  const [formData, setFirstName] = useState({[firstName]});
  ...
  return (
    <div>
      ...
      <form>
        <label>
          First Name: <input onChange={onChange} />
        </label>
        <br />
        <label>
          Last Name: <input onChange={onChange} />
        </label>
        <br />
        <label>
          Favorite Brand: <input onChange={onChange} />
        </label>
      </form>
    </div>
  );
