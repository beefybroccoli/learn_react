...
function App() {
  ...
  const cb_onChange = (event) => {
    ...
    if ((event.target.name = "input_text_firstName")) {
      console.log("case first event.target.lvaue = ", event.target.value);
    }

    if ((event.target.name = "input_text_lastName")) {
      console.log("case last event.target.vaue = ", event.target.value);
    }

    if ((event.target.name = "input_text_email")) {
      console.log("case first event.target.vaue = ", event.target.value);
    }
