...
export function UserProfile(props) {
  ...
  return (
    <div>
      ...
      <BrowserRouter>
        <Link to="/userprofile/users/:id/1">User 1</Link>
        <Link to="/userprofile/users/:id/2">User 2</Link>
        <Link to="/userprofile/users/:id/3">User 3</Link>

        <Route
          path="/userprofile/users/:id"
          render={() => cb_CompUser(props)}
        />
      </BrowserRouter>
    </div>
  );
